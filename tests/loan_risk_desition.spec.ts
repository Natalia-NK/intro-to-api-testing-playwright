...
test ('post credit info with incorrect data should receive code 200', async ({ request }) => {
...
test ('post credit info with correct data should receive code 200', async ({ request })  => {
...
test ('post credit info with data should receive code 200', async ({ request }) => {
