...
test('post credit info with positive decision (medium risk) should receive code 200', async ({ request }) => {
...
test('post credit info with positive decision (low risk) should receive code 200', async ({ request }) => {
